// src/components/PlayerIcons.tsx
import React from "react";

export const IconPlay = ({ size = 26 }: { size?: number }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" aria-hidden>
    <path d="M8 5.5v13a1 1 0 001.5.9l9.5-6.5a1 1 0 000-1.7L9.5 4.7A1 1 0 008 5.5z" fill="currentColor" />
  </svg>
);

export const IconPause = ({ size = 26 }: { size?: number }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" aria-hidden>
...
export const IconNextNew = ({ size = 24 }: { size?: number }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" aria-hidden>
    <path
...
export const IconPrevNew = ({ size = 24 }: { size?: number }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" aria-hidden>
...
export const IconShuffle = ({ size = 22 }: { size?: number }) => (
