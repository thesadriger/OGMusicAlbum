    ...
    <div className="max-w-3xl mx-auto space-y-4 player-safe">
      ...
      <div className="rounded-2xl border border-zinc-200 dark:border-zinc-800 bg-white/70 dark:bg-zinc-900/60 p-3">
        <div className="flex items-center gap-2">
          ...
          {/* Временно отключенная кнопка создания плейлистов */}
          <button
            type="button"
            disabled
            aria-disabled="true"
            title="Создание публичного плейлиста — в разработке"
            className="px-3 py-2 rounded-xl bg-zinc-200 dark:bg-zinc-800 text-zinc-500 dark:text-zinc-400 text-sm cursor-not-allowed opacity-70"
          >
        ...
        <div className="mt-2 text-xs text-zinc-500 dark:text-zinc-400">Создание публичного плейлиста — в разработке</div>
      </div>
